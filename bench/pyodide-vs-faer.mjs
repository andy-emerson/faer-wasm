...
// TEMPORARY ROUTING (c64 BLAS roofline draws — revert after draws):
// build the self-contained blas-bench wasm, verify the c64 determinism
// probes against native bits, print the three c64 roofline tables, exit.
{
